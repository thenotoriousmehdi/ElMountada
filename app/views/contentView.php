                    ...
                    <?php foreach ($content as $item): ?>
                        <div
                            ...
                            <?php if (!empty($item->image_path)): ?>
                                <img src="<?= ROOT . htmlspecialchars($item->image_path); ?>"
                ...
                <div class="flex flex-col justify-center items-center bg-gray-100 pb-8 rounded-[15px] bg-opacity-10 gap-4 mb-8">
                    <?php if (!empty($content->image_path)): ?>
                        <div class="flex flex-col items-center">
                            <img src="<?= ROOT . htmlspecialchars($content->image_path) ?>"
                                alt="Content Image"
                                ...
                                <?php if (!empty($users)): ?>
                                    <?php foreach ($users as $user): ?>
                                        <tr class="border-t border-primary/5 hover:bg-primary/10">
                                            ...
                                            <td class="py-5 px-4 text-sm font-openSans text-principale"><?= htmlspecialchars($user->phone_number ?? "N/A") ?></td>
    ...
    public function ContentTable($content, $villes)
    {
        ...
        if (empty($content)) {
            ...
            foreach ($content as $item) {
                ...
                echo "<td class='py-5 px-4 text-sm font-openSans text-principale'>";
                echo  isset($item->image_path) && !empty($item->image_path) ? "<img src='" . htmlspecialchars(ROOT . $item->image_path) . "' alt='Image' width='50'>"
                    : 'No Image';
                echo "</td>";
