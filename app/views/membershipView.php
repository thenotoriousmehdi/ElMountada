  ...
  ?>
    <div class="flex flex-col justify-start gap-2 mb-8">
      ...
      <div class="bg-text/5 shadow-sm w-full h-full overflow-y-auto rounded-[15px] p-6">
        <form action="/ElMountada/membership/handleMembershipRequest/?id=<?= htmlspecialchars($sessionData['user_id'])?>" method="POST" enctype="multipart/form-data" class="space-y-4">
          <div>
  ...
  public function displayMembers($members)
{
    ...
    if (empty($members)) {
        ...
        echo '<div class="overflow-auto w-full h-full">';
        ...
        foreach ($members as $member) {
            ...
            // Check if the member object exists and if the properties are set before accessing them
