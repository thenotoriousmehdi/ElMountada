...
JOIN 
    ...
    LEFT JOIN membership_types mt ON so.membership_type_id = mt.id
...
";
    ...
    public function getFilteredOffers($ville = null, $categoryId = null, $type = null, $membershipTypeId = null, $sortColumn = null, $sortDirection = 'ASC')
{
    $queryReductions = "
        SELECT
            'reduction' AS type,
        ...
        JOIN
            categories c ON p.categorie_id = c.id
        LEFT JOIN
            membership_types mt ON r.membership_type_id = mt.id
    ";
    ...
    $querySpecialOffers = "
        ...
        JOIN
            categories c ON p.categorie_id = c.id
        LEFT JOIN
            membership_types mt ON so.membership_type_id = mt.id
    ";
    ...
    $queryAdvantages = "
        ...
        JOIN
            categories c ON p.categorie_id = c.id
        LEFT JOIN
            membership_types mt ON a.membership_type_id = mt.id
    ";
    ...
    if ($membershipTypeId) {
        $whereClauses[] = "mt.id = :membership_type_id";
...
{
    $query = "SELECT id, name, description, price FROM membership_types";
    return $this->query($query);
}
