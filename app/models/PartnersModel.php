    ...
    public function getPartnerDetails($partnerId)
{
    $query = "SELECT
        ...
        GROUP_CONCAT(DISTINCT reductions.id ORDER BY reductions.reduction_value) AS reduction_ids,
        ...
        GROUP_CONCAT(DISTINCT advantages.id ORDER BY advantages.description) AS advantage_ids,
        ...
        GROUP_CONCAT(DISTINCT special_offers.id ORDER BY special_offers.reduction_value) AS special_offer_ids,
